...
(function(){
	...
	function AppView(){
		...
		document.body.addEventListener("checked",this.upDateStatus,false);
		document.body.addEventListener("unchecked",this.upDateStatus,false);
	...
	AppView.prototype.upDateStatus = function(e){
